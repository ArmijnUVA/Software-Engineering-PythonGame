...
#
# Pas SERVER_IP aan naar het IP-adres van de computer die de server draait.
# Vind je IP met 'ipconfig' (Windows) of 'ifconfig' (Mac/Linux).

# =============================================================================
# SERVER SETTINGS
# =============================================================================

# IP-adres van de server (vind via 'ipconfig' op Windows of 'ifconfig' op Mac/Linux)
SERVER_IP = "172.20.208.1"  # Verander naar bijv. "192.168.1.100" voor netwerk play
SERVER_PORT = 5555
MAX_PLAYERS = 4
